...
@Component
@AllArgsConstructor
public class ButtonFridayHandler implements CallbackQueryHandler {
    ...
    public SendMessage handle(CallbackQuery callbackQuery) {
        ...
        lesson.append(timeTableProvider.getTimetableByDay(userService.getUser(userId).get().getStudentGroup(), DayOfWeek.FRIDAY , WeekState.WEEK_ONE));
        lesson.append(timeTableProvider.getTimetableByDay(userService.getUser(userId).get().getStudentGroup(), DayOfWeek.FRIDAY ,WeekState.WEEK_TWO));
