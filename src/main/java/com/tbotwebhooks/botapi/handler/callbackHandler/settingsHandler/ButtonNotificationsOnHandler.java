...
@Component
@AllArgsConstructor
public class ButtonNotificationsOnHandler implements CallbackQueryHandler {
    ...
    public SendMessage handle(CallbackQuery callbackQuery) {
        ...
        userService.setBotState(userId, BotState.NOTIFICATION_TIME);

        return messageService.getReplyMessage(chatId, "reply.settings.notifications.time");
    }

    @Override
    public String getHandleName() {
        return "buttonNotificationsOn";
    }
}
