...
@Component
@AllArgsConstructor
public class ButtonNextDayHandler implements CallbackQueryHandler {
    ...
    public SendMessage handle(CallbackQuery callbackQuery) {
        ...
        DayOfWeek dayOfWeek = zonedDateTime.getDayOfWeek().plus(1);
        WeekState weekState = CurrentWeekState.getWeekState(zonedDateTime.plusDays(1));
