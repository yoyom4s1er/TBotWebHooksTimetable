...
@Component
@AllArgsConstructor
public class ButtonAfterTwoDaysHandler implements CallbackQueryHandler {
    ...
    public SendMessage handle(CallbackQuery callbackQuery) {
        ...
        DayOfWeek dayOfWeek = zonedDateTime.getDayOfWeek().plus(2);
        WeekState weekState = CurrentWeekState.getWeekState(zonedDateTime.plusDays(2));
