...
@Component
@AllArgsConstructor
public class ButtonAfterThreeDaysHandler implements CallbackQueryHandler {
    ...
    public SendMessage handle(CallbackQuery callbackQuery) {
        ...
        DayOfWeek dayOfWeek = zonedDateTime.getDayOfWeek().plus(3);
        WeekState weekState = CurrentWeekState.getWeekState(zonedDateTime.plusDays(3));
