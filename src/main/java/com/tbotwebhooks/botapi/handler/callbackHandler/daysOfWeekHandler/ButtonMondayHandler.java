...
@Component
@AllArgsConstructor
public class ButtonMondayHandler implements CallbackQueryHandler {
    ...
    public SendMessage handle(CallbackQuery callbackQuery) {
        ...
        lesson.append(timeTableProvider.getTimetableByDay(userService.getUser(userId).get().getStudentGroup(), DayOfWeek.MONDAY ,WeekState.WEEK_ONE));
        lesson.append(timeTableProvider.getTimetableByDay(userService.getUser(userId).get().getStudentGroup(), DayOfWeek.MONDAY ,WeekState.WEEK_TWO));
