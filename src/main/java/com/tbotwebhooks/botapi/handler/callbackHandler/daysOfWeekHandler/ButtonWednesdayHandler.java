...
@Component
@AllArgsConstructor
public class ButtonWednesdayHandler implements CallbackQueryHandler {
    ...
    public SendMessage handle(CallbackQuery callbackQuery) {
        ...
        lesson.append(timeTableProvider.getTimetableByDay(userService.getUser(userId).get().getStudentGroup(), DayOfWeek.WEDNESDAY , WeekState.WEEK_ONE));
        lesson.append(timeTableProvider.getTimetableByDay(userService.getUser(userId).get().getStudentGroup(), DayOfWeek.WEDNESDAY ,WeekState.WEEK_TWO));
