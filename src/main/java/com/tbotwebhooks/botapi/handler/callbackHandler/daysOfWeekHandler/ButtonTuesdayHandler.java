...
@Component
@AllArgsConstructor
public class ButtonTuesdayHandler implements CallbackQueryHandler {
    ...
    public SendMessage handle(CallbackQuery callbackQuery) {
        ...
        lesson.append(timeTableProvider.getTimetableByDay(userService.getUser(userId).get().getStudentGroup(), DayOfWeek.TUESDAY , WeekState.WEEK_ONE));
        lesson.append(timeTableProvider.getTimetableByDay(userService.getUser(userId).get().getStudentGroup(), DayOfWeek.TUESDAY ,WeekState.WEEK_TWO));
